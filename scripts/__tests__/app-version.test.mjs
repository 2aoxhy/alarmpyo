...
describe('V15 앱 버전 계약', () => {
  ...
  it('npm용 1.15.0과 앱 표시용 1.15를 같은 릴리스로 봐요', () => {
    expect(isSupportedPackageVersion('1.15.0')).toBe(true);
    expect(isSupportedAppVersion('1.15')).toBe(true);
    expect(packageVersionMatchesApp('1.15.0', '1.15')).toBe(true);
    expect(packageVersionMatchesApp('1.16.0', '1.15')).toBe(false);
  });
