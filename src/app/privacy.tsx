...
const POLICY_SECTIONS = [
  {
    title: '처리하는 정보',
    body: '알람표는 계정을 만들지 않으며 광고·분석 도구를 사용하지 않습니다. 근무표, 알람·타이머 설정, 메모, 화면 설정은 이 기기의 앱 저장 공간에 보관합니다.',
  },
  {
    title: '외부 전송',
    body: '근무 데이터는 자동으로 외부 서버에 전송하지 않습니다. 백업이나 근무 설정 공유를 직접 선택한 경우에만 사용자가 고른 앱 또는 저장 위치로 파일을 전달합니다.',
  },
  {
    title: '업데이트 통신',
  ...
  {
    title: '공개 방침 페이지',
    body: '웹에서 공개 방침 페이지를 열 때에만 GitHub Pages가 서비스의 보안과 무결성을 유지하기 위해 방문자의 IP 주소를 기록·저장합니다. 이 웹 호스팅 로그는 앱의 근무표·메모·알람·타이머 설정 전송이 아니며, 앱이 GitHub Pages에 자동 접속하지 않습니다.',
  },
  {
    title: '수면 안내와 건강 정보',
  ...
  {
    title: '권한 사용',
    body: '알림, 정확한 알람, 전체 화면 알람, 진동, 부팅 후 알람 복구와 알람음 재생 권한은 근무·타이머 알람을 제시간에 전달하는 데 사용합니다. 파일은 Android 시스템 선택 화면에서 사용자가 직접 고른 항목만 읽거나 저장합니다.',
  },
  {
    title: '보관과 삭제',
    body: '설정에서 초기화하면 현재 근무표·메모·설정이 초기화되고 실행 중인 타이머가 취소되지만, 복구할 수 있도록 초기화 직전 근무 자료를 앱 내부 안전 백업으로 남깁니다. 앱을 삭제하면 현재 자료와 내부 안전 백업이 함께 삭제됩니다. 외부로 내보낸 백업 파일은 저장한 위치에서 직접 삭제해야 합니다. Expo가 처리하는 업데이트 기술 정보는 Expo의 보관·삭제 기준을 따릅니다.',
  },
  {
    title: '아동과 계정',
